...
let columnHeight = [5,5,5,5,5,5,5]; //used later to give the height (y) value for cells to track lowest empty cell
...
if (board.every(row => row.every(cell => cell))) {
  ...
  //could probably also use a "?" checker 
  if (currPlayer === 1){
    currPlayer = 2;
  }else {
    currPlayer = 1;
  }
  //decrements height array to reflect new lowest empty cell
  y -=1;
  columnHeight[x] = y;
}
